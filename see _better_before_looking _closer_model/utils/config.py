...
def getDatasetConfig(dataset_name):
    ...
    dataset_dict = {
        ...
        'car': {'train_root': '/content/Cars/train',
                'val_root': '/content/Cars/test',
                'train': '/content/drive/My Drive/WS_DAN_PyTorch-master/train_car',
                'val': '/content/drive/My Drive/WS_DAN_PyTorch-master/test_car'},
